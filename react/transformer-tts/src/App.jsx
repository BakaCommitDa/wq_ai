...
import Progress from './compoments/Progress.jsx';
import AudioPlayer from './compoments/AudioPlayer.jsx';
          ...
          }
          {
            progressItems.map(data =>(
              <div key={`${data.name}/${data.file}`}>
                <Progress text={`${data.name}/${data.file}`} 
